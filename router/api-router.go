...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/wildflow/catalog", controller.GetWildFlowCatalog)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.POST("/self/voices", controller.CreateWildFlowVoice)
				selfRoute.GET("/self/voice-preference", controller.GetWildFlowVoicePreference)
				selfRoute.PUT("/self/voice-preference", controller.SetWildFlowVoicePreference)
